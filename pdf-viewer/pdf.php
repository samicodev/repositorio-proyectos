...
<head>
    ...
    <title>Visor PDF | INCOS Pando</title>
...
<body>
    ...
    <script>
        ...
        function renderPage(num) {
            ...
            document.getElementById('page_num_input').value = num; // Actualiza el input
        }
        ...
        function loadPDF() {
            ...
            pdfjsLib.getDocument(archivoPDF).promise.then((pdfDoc_) => {
                ...
                document.getElementById('top-bar').style.display = 'block'; // Cambia a block aquí
