			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">Modalidades</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<form class="form-horizontal" action="guardar_modalidad.php" method="POST" enctype="multipart/form-data">
					<div class="modal-body">
						
						<div class="form-group row">
							<label for="inputName" class="col-md-3 form-label">Modalidad</label>
							<div class="col-md-7">
								<input type="text" placeholder="Modalidad" class="form-control" required name="nombre" autocomplete="off">
							</div>
						</div>
											...
											<div class="table-responsive">
												<table id="example" class="table table-bordered text-nowrap key-buttons">
													<thead>
														<tr>
															...
															<th class="border-bottom-0">Modalidades</th>
												...
												<?php foreach($mbd->query("SELECT * from modalidad") as $fila) { ?>
														<tr>
															...
															<td>
						<a class="btn btn-link" href="elim_modalidad.php?id=<?php echo $fila['id']; ?>" onclick="return confirm('¿Seguro que desea ELIMINAR. ?')">
